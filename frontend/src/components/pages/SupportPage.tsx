      ...
      {section === 'bonus' && (
        <div className="mb-6">
          ...
          <div className="mb-6">
            ...
            <p style={{ color: colors.mutedForeground }}>Получите 100% бонус на первый депозит</p>
          </div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p style={{ color: colors.mutedForeground }} className="text-sm">Сразу после пополнения счёта (если это первый депозит)</p>
                  </div>
                </div>
              </div>
            </Card>
          ...
          <div className="grid grid-cols-3 gap-2 mb-6">
            <Card className="p-4 border cursor-pointer transition-all hover:scale-105" style={{
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <p className="text-xs font-semibold text-center" style={{ color: colors.foreground }}>Бонус</p>
              </div>
            </Card>
